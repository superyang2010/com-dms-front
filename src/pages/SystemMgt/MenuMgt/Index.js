...
class MenuList extends PureComponent {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'menuMgt/queryMenuTree'
    });
    dispatch({
      type: 'menuMgt/fetchRoles'
    });
  ...
  handleSubmit = e => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      let dispatchType = 'menuMgt/add';
      if (isEdit) {
        fieldsValue.id = currentMenuData.id;
        dispatchType = 'menuMgt/modify';
      } else if (isAdd) {
        fieldsValue.parentId = currentMenuData.id;
        dispatchType = 'menuMgt/add';
      }
      dispatch({
        type: dispatchType,
        payload: fieldsValue,
